...
export const socialIcons = [
  { icon: <GithubOutlined />, url: 'https://github.com/2249719242/wanxinhomepage.git' },
...
//本地：
export const AICHATURL = 'http://127.0.0.1:5000/'
export const AICOVERURL = 'http://127.0.0.1:5000/'
//服务器：

// export const AICOVERURL = 'https://marmoset-frank-quickly.ngrok-free.app/'
